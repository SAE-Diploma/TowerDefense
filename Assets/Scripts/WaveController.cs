...
public class WaveController
{
    ...
    {
        {0, new EnemyCollection(){ Standard=100, Fast=0, Tank=0, Warrior=0,Flying=0 } },
    ...
    private int currentDifficulty = 100;
    ...
    public EnemyCollection[] GetDistribution(int spawnerCount)
    {
